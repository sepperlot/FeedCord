...
![FeedCord Banner](https://github.com/sepperlot/FeedCord/blob/master/FeedCord/docs/images/FeedCord.png)
...
![FeedCord Gallery 1](https://github.com/sepperlot/FeedCord/blob/master/FeedCord/docs/images/gallery1.png)

![FeedCord Gallery 2](https://github.com/sepperlot/FeedCord/blob/master/FeedCord/docs/images/gallery2.png)
...
There is currently 17 properties you can configure. You can read a more in-depth explanation of the file structure as well as view all properties and their purpose in the configuration reference: [FeedCord appsettings reference](https://github.com/sepperlot/FeedCord/blob/master/FeedCord/docs/reference.md)

---

### 2. Create a new Webhook in Discord (Visual Steps Provided)

![Discord Webhook](https://github.com/sepperlot/FeedCord/blob/master/FeedCord/docs/images/webhooks.png)
...
```bash
git clone https://github.com/sepperlot/FeedCord
```
